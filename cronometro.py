from tkinter import  Button, messagebox , Label,Tk,ttk
...
terminar = Button(ventana, text= 'Terminar', bg= 'black', fg= 'magenta', font= ('Arial',12, 'bold'), command=ventana.destroy)
...
combobox3.current(0)
terminar.grid(row=4, column=2, padx =15, pady=5)
